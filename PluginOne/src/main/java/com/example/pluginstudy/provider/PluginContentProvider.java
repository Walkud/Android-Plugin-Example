package com.example.pluginstudy.provider;
...
public class PluginContentProvider extends ContentProvider {
    ...
    private static final String TAG = PluginContentProvider.class.getSimpleName();
    ...
    public Uri insert(Uri uri, ContentValues values) {
        Log.d(TAG, "insert:" + uri + ",values:" + values.toString());
        // TODO Auto-generated method stub
        String TABLE_NAME;
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        Log.d(TAG, "update:" + uri + ",values:" + values.toString());
        // TODO Auto-generated method stub
        SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        Long now = Long.valueOf(System.currentTimeMillis());
