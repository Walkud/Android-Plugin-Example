 ...
 * BindService
 */
public class ServiceBindOne extends Service {

    private static final String TAG = ServiceBindOne.class.getSimpleName();
    ...
    public class MyBinderOne extends Binder {
        ...
        public ServiceBindOne getService() {
            return ServiceBindOne.this;
        }
    }
