...
public class ManifestParser {
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG: {
                        ...
                        if (tag.equals("manifest")) {
                            ...
                            String processName = parser.getAttributeValue(namespaceAndroid, "process");
                            ...
                            addProcessName(desciptor, name, processName);
                            ...
                            String name = addIntentFilter(map, packageName, namespaceAndroid, parser, "receiver");
                            addProcessName(desciptor, name, processName);
    ...
    private static void addProcessName(PluginDescriptor desciptor, String activityName, String processName) {
