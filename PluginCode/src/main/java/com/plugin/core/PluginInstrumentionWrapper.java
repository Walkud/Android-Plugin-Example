...
public class PluginInstrumentionWrapper extends Instrumentation {
	...
	public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, Activity target,
		...
		Object result = RefInvoker.invokeMethod(realInstrumention, Instrumentation.class.getName(),
	...
	public void execStartActivities(Context who, IBinder contextThread, IBinder token, Activity target,
		...
		RefInvoker
				.invokeMethod(realInstrumention, Instrumentation.class.getName(), "execStartActivities",
